...
export function TeamAdminBar() {
  ...
  return (
    <>
      <div className="flex items-center justify-between px-5 py-3 mb-10 rounded-2xl bg-amber-50 border border-amber-200/80 shadow-[0_0_20px_rgba(245,158,11,0.08)]" suppressHydrationWarning>
